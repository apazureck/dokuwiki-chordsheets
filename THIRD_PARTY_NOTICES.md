...
This DokuWiki plugin bundles the following third-party JavaScript libraries:

## jTab

- Bundled file: `js/jtab.min.js`
- Project: [jTab](http://jtab.tardate.com/)
- Copyright: Paul Gallagher and jTab contributors
- License: GNU Lesser General Public License, version 2.1 or later

## Raphaël

- Bundled file: `js/raphael.js`
- Project: [Raphaël](https://github.com/DmitryBaranovskiy/raphael)
